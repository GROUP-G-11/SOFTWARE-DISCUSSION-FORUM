...
<body>
    <div class="panel">
        ...
        <div class="footer">Already registered? <a href="<?php echo e(route('login')); ?>">Log in</a></div>
    </div>
    <script>
...
<?php /**PATH C:\SOFTWARE-DISCUSSION-FORUM-Grading-and-Participation\resources\views/auth/register.blade.php ENDPATH**/ ?>